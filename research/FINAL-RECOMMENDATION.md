...
🔗 **[https://www.youtube.com/watch?v=8vXoI7lUroQ](https://www.youtube.com/watch?v=8vXoI7lUroQ)**
...
## 📊 الشيتس + الداشبورد (تنزّلهم على الجهاز)

### ⭐ الأسهل: ملف واحد بدون انترنت ولا سيرفر

📂 [`sheets/local-brand-roadmap-offline.html`](sheets/local-brand-roadmap-offline.html) — **(78 KB · يفتح بنقرة واحدة)**

- كل الداتا (78 task + 43 video + 55 tool + 19 prompt) جوّاه.
- شغّال محلياً على أي جهاز بدون انترنت.
- فلاتر + بحث + ترتيب على كل الأعمدة.
- Checkboxes للتقدم — محفوظ تلقائياً في المتصفح (localStorage).
- زر Export/Import للتقدم كـ JSON.
- Print-friendly — اطبع أو حوّل لـ PDF بـ Ctrl+P.

**الاستخدام:**
1. حمّل الملف.
2. Double-click عشان يفتح في المتصفح.
3. هتشتغل من غير ما تحتاج أي حاجة.

### حزمة كاملة (ZIP)

📦 [`downloads/local-brand-roadmap-bundle.zip`](downloads/local-brand-roadmap-bundle.zip) — **(60 KB)**

فيه: الملف التفاعلي + الـ 4 شيتس CSV + خريطة الطريق Markdown + ملف التوصية.

### ملفات منفصلة

| الملف | الوصف |
| --- | --- |
| [sheets/01-execution-plan.csv](sheets/01-execution-plan.csv) | كل التاسكات يوم بيوم (78 تاسك) |
| [sheets/02-videos-library.csv](sheets/02-videos-library.csv) | 43 فيديو موثوق مرتب بالأولوية |
| [sheets/03-tools-accounts.csv](sheets/03-tools-accounts.csv) | 55 أداة وحساب وريبو |
| [sheets/04-prompts-library.csv](sheets/04-prompts-library.csv) | 19 Prompt جاهز للنسخ |
| [sheets/index.html](sheets/index.html) | داشبورد بيقرا الـ CSVs (محتاج سيرفر بسيط `npx http-server`) |

تقدر تستورد الـ CSVs مباشرة في Excel أو Google Sheets أو Numbers.
...
- فتحت Greg Isenberg #1 ([https://www.youtube.com/watch?v=8vXoI7lUroQ](https://www.youtube.com/watch?v=8vXoI7lUroQ)).
